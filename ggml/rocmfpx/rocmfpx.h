...
#define QK_ROCMFP5 QK_ROCMFPX
#define QK_ROCMFP6 QK_ROCMFPX
#define QK_ROCMFP7 QK_ROCMFPX
...
#define QS_ROCMFP5 ((QK_ROCMFP5 * 5) / 8)
#define QS_ROCMFP6 ((QK_ROCMFP6 * 6) / 8)
#define QS_ROCMFP7 ((QK_ROCMFP7 * 7) / 8)
...
#define QR_ROCMFP5 1
#define QI_ROCMFP5 (QK_ROCMFP5 / (4 * QR_ROCMFP5))
...
static_assert(sizeof(block_rocmfp5) == QS_ROCMFP5 + 2*sizeof(uint8_t), "wrong rocmfp5 block size/padding");
static_assert(sizeof(block_rocmfp6) == QS_ROCMFP6 + 2*sizeof(uint8_t), "wrong rocmfp6 block size/padding");
static_assert(sizeof(block_rocmfp7) == QS_ROCMFP7 + 2*sizeof(uint8_t), "wrong rocmfp7 block size/padding");
...
_Static_assert(sizeof(block_rocmfp5) == QS_ROCMFP5 + 2*sizeof(uint8_t), "wrong rocmfp5 block size/padding");
_Static_assert(sizeof(block_rocmfp6) == QS_ROCMFP6 + 2*sizeof(uint8_t), "wrong rocmfp6 block size/padding");
_Static_assert(sizeof(block_rocmfp7) == QS_ROCMFP7 + 2*sizeof(uint8_t), "wrong rocmfp7 block size/padding");
...
GGML_API size_t rocmfpx_row_size_fp5(int64_t k);
...
GGML_API void   rocmfpx_quantize_row_fp5_ref(const float * GGML_RESTRICT x, block_rocmfp5 * GGML_RESTRICT y, int64_t k);
GGML_API void   rocmfpx_dequantize_row_fp5(const block_rocmfp5 * GGML_RESTRICT x, float * GGML_RESTRICT y, int64_t k);
GGML_API void   rocmfpx_quantize_row_fp5(const float * GGML_RESTRICT x, void * GGML_RESTRICT y, int64_t k);
GGML_API size_t rocmfpx_quantize_fp5(const float * GGML_RESTRICT src, void * GGML_RESTRICT dst, int64_t nrows, int64_t n_per_row, const float * imatrix);
...
GGML_API bool rocmfpx_validate_row_data_fp5(const void * data, size_t nbytes);
