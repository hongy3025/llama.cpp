...
extern "C" {
    ...
    enum ggml_type {
        ...
        GGML_TYPE_Q1_0    = 41,
        GGML_TYPE_Q2_0    = 42,
        // ROCmFP4 STRIX variants (values match the GGUF artifacts produced by the
        // ROCmFPX project, so they must keep these fixed ids)
        GGML_TYPE_Q4_0_ROCMFP4      = 100, // ROCmFP4 dual half-block UE4M3 scales
