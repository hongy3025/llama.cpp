...
static const struct ggml_type_traits type_traits[GGML_TYPE_COUNT] = {
    ...
    [GGML_TYPE_Q4_0_ROCMFP4] = {
        ...
        .is_quantized             = true,
        .to_float                 = (ggml_to_float_t) dequantize_row_q4_0_rocmfp4,
        .from_float_ref           = (ggml_from_float_t) quantize_row_q4_0_rocmfp4_ref,
    },
    [GGML_TYPE_Q4_0_ROCMFP4_FAST] = {
        ...
        .is_quantized             = true,
        .to_float                 = (ggml_to_float_t) dequantize_row_q4_0_rocmfp4_fast,
        .from_float_ref           = (ggml_from_float_t) quantize_row_q4_0_rocmfp4_fast_ref,
    },
    [GGML_TYPE_Q2_K] = {
        .type_name                = "q2_K",
        .blck_size                = QK_K,
...
size_t ggml_quantize_chunk(
    ...
    switch (type) {
        ...
        case GGML_TYPE_Q4_0_ROCMFP4:      result = quantize_q4_0_rocmfp4      (src + start, (char *) dst + start_row * row_size, nrows, n_per_row, imatrix); break;
        case GGML_TYPE_Q4_0_ROCMFP4_FAST: result = quantize_q4_0_rocmfp4_fast (src + start, (char *) dst + start_row * row_size, nrows, n_per_row, imatrix); break;
