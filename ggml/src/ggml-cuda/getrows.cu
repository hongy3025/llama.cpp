...
static void ggml_cuda_get_rows_switch_src0_type(
    ...
    switch (src0_type) {
        ...
        case GGML_TYPE_Q5_0_ROCMFPX:
            get_rows_cuda_q<QK_ROCMFP5, QR_ROCMFP5, dequantize_rocmfpx_fp5>(src0_d, src1_d, dst_d,
                ne00, nb01, nb02, nb03, ne10, ne11, ne12, nb10, nb11, nb12, nb1, nb2, nb3, stream);
            break;
        ...
        case GGML_TYPE_Q7_0_ROCMFPX:
            get_rows_cuda_q<QK_ROCMFP7, QR_ROCMFP7, dequantize_rocmfpx_fp7>(src0_d, src1_d, dst_d,
                ne00, nb01, nb02, nb03, ne10, ne11, ne12, nb10, nb11, nb12, nb1, nb2, nb3, stream);
            break;
